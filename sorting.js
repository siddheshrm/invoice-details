...
function sortTable(columnIndex, dataType, isAscending) {
  ...
  rowsArray.sort((rowA, rowB) => {
    ...
    switch (dataType) {
        // Convert non-N/A values to numbers for comparison
      case "numeric": return isAscending ? parseFloat(cellA) - parseFloat(cellB) : parseFloat(cellB) - parseFloat(cellA);
      case "alphanumeric": return isAscending ? cellA.localeCompare(cellB) : cellB.localeCompare(cellA);
      default: return 0;            // For unrecognised data-type
    }
  });
